package com.abmtech.insight.config;

public class AppConfig {

    //your Server Key obtained from the admin panel
    public static final String SERVER_KEY = "WVVoU01HTklUVFpNZVRsb1dXMHhNRnBYVG05TWJsSnNXVEpuZG1OSVNuWmhiVlpxWkVoTmRtSnRWak5qTVRsb1kwaENjMkZYVG1oa1IyeDJZbXRzYTFneVRuWmlVelZvV1cweE1GcFhUbTlNYld4MVl6SnNibUZJVVQwPQ==\n";
